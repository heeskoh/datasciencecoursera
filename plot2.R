plot2 <- function() {
	...
	plot(strptime(DT$GraphDate, format="%d/%m/%Y %H:%M:%S"), DT$Global_active_Power, main="Global active Power per Weekday", type = "l" , col="black", xlab ="", ylab ="Global active Power(killowatts)")
